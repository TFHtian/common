...
class RoundedCornersTransformation @JvmOverloads constructor(private val radius: Int,
                                                             ...
                                                             private val cornerType: ImageOptions.CornerType = ImageOptions.CornerType.ALL
    ...
    override fun equals(other: Any?): Boolean {
        return other is RoundedCornersTransformation && other.radius == radius && other.diameter == diameter && other.margin == margin && other.cornerType == cornerType
    }
