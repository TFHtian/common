...
abstract class BaseVpDbRefreshFragment<M : BaseModel, V : BaseRefreshContract.View, P : BaseRefreshPresenter<M, V>, DB : ViewDataBinding> :
    BaseVpDbFragment<M, V, P, DB>(), BaseRefreshContract.View {
